...
const tourist_places = [
    { Image: campinagrande, title: " campinagrande", description: " Ponto turistico para a familia" },
    { Image: coliseu, title: " coliseu", description: " Ponto turistico " },
    { Image: cristoredentor, title: "cristoredentor", description: "ponto turistico no Rio de Janeiro" },
    { Image: maracana, title: "maracana", description: "Melhor lugar para ir em familia" },
    { Image: ponte, title: " ponte", description: "ponto turistico de Brasilia" },
    { Image: sãoluis, title: "são luis", description: "melhor lugar na hospedagem" },
]
