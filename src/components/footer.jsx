...
const Footer = () => {
    return (
        <>
        <footer className="w-full bg-gradient-to-r from-purple-600 to-blue-700 text-black py-2 px-2 shadow-lg mt-auto">
            <div className="w-full mx-auto flex flex-col md:flex-row justify-between items-center">
                ...
                <a href="#" className="hover:text-blue-300"><FaWhatsapp/></a>
