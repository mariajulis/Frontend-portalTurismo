...
const Navbar = () => {
    ...
    return (
        ...
        <nav className="w-full bg-gradient-to-r from-blue-600 to-purple-700 text-gray-800 py-0 px-2 shadow-lg fixed top-0 left-0 z-30">
            {/* Container interno com limite máximo de largura e flexbox para espaçar os itens */}
            <div className="max-w-7xl mx-auto flex justify-between items-center">
                
                {/* Logo/título do site */}
                <div className="flex items-center">
                    <a href="/" className="ml-[7.5px] text-2xl font-extrabold text-white hover:text-blue-600 transition-colors duration-300">
                        Nova Serra Verde
                    </a>
                </div>
            ...
            <div className={`lg:hidden bg-gradient-to-r from-blue-600 to-purple-600 p-4 transition-all duration-300 ${isMenuOpen ? 'block' : 'hidden'}`}>
                {menuLinks}
            </div>
        </nav>
    );
